...
public class AdminController : Controller
{
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        ViewBag.HasOrderItems = hasOrderItems;
    ...
    public async Task<IActionResult> DeleteConfirmed(int id)
    {
        ...
        if (hasOrderItems)
        {
            TempData["ErrorMessage"] = $"Cannot delete product '{product.Name}' because it has been ordered. Products with order history cannot be deleted.";
        ...
        {
            TempData["ErrorMessage"] = $"Cannot delete product '{product.Name}'. It may be referenced by existing orders.";
            return RedirectToAction(nameof(ProductsList));
        }
